...
const TableName string = "balances"
...
func (crud Crud_DB) Read(m *balances.Balance) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *balances.Balance) error {
	var err error
...
func (crud Crud_DB) Save(m *balances.Balance) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *balances.Balance) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *balances.Balance) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *balances.Balance) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *balances.Balance) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *balances.Balance) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *balances.Balance, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *balances.Balance, is_create bool) error {
	var err error
	...
	ColumnName = "DocumentPaymentID"
	if m.DocumentPaymentID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}
	...
	ColumnName = "DocumentAt"
	if m.DocumentAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
...
func (crud Crud_DB) Delete(m *balances.Balance) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *balances.Balance) error {
	var err error
...
func (crud Crud_DB) Restore(m *balances.Balance) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *balances.Balance) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID(m *balances.Balance) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID_ctx(ctx context.Context, m *balances.Balance) error {
	var err error
