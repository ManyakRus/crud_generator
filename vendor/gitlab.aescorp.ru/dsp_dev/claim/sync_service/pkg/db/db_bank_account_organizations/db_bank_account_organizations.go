...
package db_bank_account_organizations
...
const TableName string = "bank_account_organizations"
...
func (crud Crud_DB) Read(m *bank_account_organizations.BankAccountOrganization) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *bank_account_organizations.BankAccountOrganization) error {
	var err error
...
func (crud Crud_DB) Save(m *bank_account_organizations.BankAccountOrganization) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *bank_account_organizations.BankAccountOrganization) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *bank_account_organizations.BankAccountOrganization) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *bank_account_organizations.BankAccountOrganization) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *bank_account_organizations.BankAccountOrganization) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *bank_account_organizations.BankAccountOrganization) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *bank_account_organizations.BankAccountOrganization, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *bank_account_organizations.BankAccountOrganization, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *bank_account_organizations.BankAccountOrganization) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *bank_account_organizations.BankAccountOrganization) error {
	var err error
	...
	m2 := bank_account_organizations.BankAccountOrganization{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *bank_account_organizations.BankAccountOrganization) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *bank_account_organizations.BankAccountOrganization) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID(m *bank_account_organizations.BankAccountOrganization) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID_ctx(ctx context.Context, m *bank_account_organizations.BankAccountOrganization) error {
	var err error
