...
const TableName string = "bill_kind_types"
...
func (crud Crud_DB) Read(m *bill_kind_types.BillKindType) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *bill_kind_types.BillKindType) error {
	var err error
...
func (crud Crud_DB) Save(m *bill_kind_types.BillKindType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *bill_kind_types.BillKindType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *bill_kind_types.BillKindType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *bill_kind_types.BillKindType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *bill_kind_types.BillKindType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *bill_kind_types.BillKindType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *bill_kind_types.BillKindType, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *bill_kind_types.BillKindType, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *bill_kind_types.BillKindType) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *bill_kind_types.BillKindType) error {
	var err error
	...
	m2 := bill_kind_types.BillKindType{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *bill_kind_types.BillKindType) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *bill_kind_types.BillKindType) error {
	var err error
