...
const TableName string = "calendars"
...
func (crud Crud_DB) Read(m *calendars.Calendar) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *calendars.Calendar) error {
	var err error
...
func (crud Crud_DB) Save(m *calendars.Calendar) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *calendars.Calendar) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *calendars.Calendar) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *calendars.Calendar) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *calendars.Calendar) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *calendars.Calendar) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *calendars.Calendar, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *calendars.Calendar, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *calendars.Calendar) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *calendars.Calendar) error {
	var err error
...
func (crud Crud_DB) Restore(m *calendars.Calendar) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *calendars.Calendar) error {
	var err error
