...
const TableName string = "claim_types"
...
func (crud Crud_DB) Read(m *claim_types.ClaimType) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *claim_types.ClaimType) error {
	var err error
...
func (crud Crud_DB) Save(m *claim_types.ClaimType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *claim_types.ClaimType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *claim_types.ClaimType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *claim_types.ClaimType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *claim_types.ClaimType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *claim_types.ClaimType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *claim_types.ClaimType, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *claim_types.ClaimType, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *claim_types.ClaimType) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *claim_types.ClaimType) error {
	var err error
...
func (crud Crud_DB) Restore(m *claim_types.ClaimType) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *claim_types.ClaimType) error {
	var err error
