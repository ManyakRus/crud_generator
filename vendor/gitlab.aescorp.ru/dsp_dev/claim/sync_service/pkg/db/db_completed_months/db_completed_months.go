...
const TableName string = "completed_months"
...
func (crud Crud_DB) Read(m *completed_months.CompletedMonth) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *completed_months.CompletedMonth) error {
	var err error
...
func (crud Crud_DB) Save(m *completed_months.CompletedMonth) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *completed_months.CompletedMonth) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *completed_months.CompletedMonth) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *completed_months.CompletedMonth) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *completed_months.CompletedMonth) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *completed_months.CompletedMonth) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *completed_months.CompletedMonth, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *completed_months.CompletedMonth, is_create bool) error {
	var err error
	...
	ColumnName = "AccountingAreaID"
	if m.AccountingAreaID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}
...
func (crud Crud_DB) Delete(m *completed_months.CompletedMonth) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *completed_months.CompletedMonth) error {
	var err error
	...
	m2 := completed_months.CompletedMonth{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *completed_months.CompletedMonth) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *completed_months.CompletedMonth) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID(m *completed_months.CompletedMonth) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID_ctx(ctx context.Context, m *completed_months.CompletedMonth) error {
	var err error
