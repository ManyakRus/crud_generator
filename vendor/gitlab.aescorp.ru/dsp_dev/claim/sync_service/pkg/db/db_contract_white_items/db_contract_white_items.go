...
package db_contract_white_items
...
const TableName string = "contract_white_items"
...
func (crud Crud_DB) Read(m *contract_white_items.ContractWhiteItem) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *contract_white_items.ContractWhiteItem) error {
	var err error
...
func (crud Crud_DB) Save(m *contract_white_items.ContractWhiteItem) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *contract_white_items.ContractWhiteItem) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *contract_white_items.ContractWhiteItem) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *contract_white_items.ContractWhiteItem) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *contract_white_items.ContractWhiteItem) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *contract_white_items.ContractWhiteItem) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *contract_white_items.ContractWhiteItem, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *contract_white_items.ContractWhiteItem, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *contract_white_items.ContractWhiteItem) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *contract_white_items.ContractWhiteItem) error {
	var err error
	...
	m2 := contract_white_items.ContractWhiteItem{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *contract_white_items.ContractWhiteItem) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *contract_white_items.ContractWhiteItem) error {
	var err error
