...
const TableName string = "contracts"
...
func (crud Crud_DB) Read(m *contracts.Contract) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *contracts.Contract) error {
	var err error
...
func (crud Crud_DB) Save(m *contracts.Contract) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *contracts.Contract) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *contracts.Contract) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *contracts.Contract) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *contracts.Contract) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *contracts.Contract) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *contracts.Contract, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *contracts.Contract, is_create bool) error {
	var err error
	...
	ColumnName = "EndAt"
	if m.EndAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "OrganizationConsigneeID"
	if m.OrganizationConsigneeID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "TerminateAt"
	if m.TerminateAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
	...
	ColumnName = "OrganizationPayerID"
	if m.OrganizationPayerID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}
	...
	ColumnName = "OrganizationCustomerID"
	if m.OrganizationCustomerID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}
	...
	ColumnName = "ErrorFromStackAt"
	if m.ErrorFromStackAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
...
func (crud Crud_DB) Delete(m *contracts.Contract) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *contracts.Contract) error {
	var err error
...
func (crud Crud_DB) Restore(m *contracts.Contract) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *contracts.Contract) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID(m *contracts.Contract) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID_ctx(ctx context.Context, m *contracts.Contract) error {
	var err error
