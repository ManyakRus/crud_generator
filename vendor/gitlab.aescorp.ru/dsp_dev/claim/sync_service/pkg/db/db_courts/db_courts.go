...
func (crud Crud_DB) Read(m *courts.Court) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *courts.Court) error {
	var err error
...
func (crud Crud_DB) Save(m *courts.Court) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *courts.Court) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *courts.Court) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *courts.Court) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *courts.Court) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *courts.Court) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *courts.Court, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *courts.Court, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *courts.Court) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *courts.Court) error {
	var err error
...
func (crud Crud_DB) Restore(m *courts.Court) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *courts.Court) error {
	var err error
