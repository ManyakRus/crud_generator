...
const TableName string = "direction_types"
...
func (crud Crud_DB) Read(m *direction_types.DirectionType) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *direction_types.DirectionType) error {
	var err error
...
func (crud Crud_DB) Save(m *direction_types.DirectionType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *direction_types.DirectionType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *direction_types.DirectionType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *direction_types.DirectionType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *direction_types.DirectionType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *direction_types.DirectionType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *direction_types.DirectionType, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *direction_types.DirectionType, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *direction_types.DirectionType) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *direction_types.DirectionType) error {
	var err error
	...
	m2 := direction_types.DirectionType{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *direction_types.DirectionType) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *direction_types.DirectionType) error {
	var err error
