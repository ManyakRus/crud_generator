...
func (crud Crud_DB) Read(m *documents.Document) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *documents.Document) error {
	var err error
...
func (crud Crud_DB) Save(m *documents.Document) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *documents.Document) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *documents.Document) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *documents.Document) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *documents.Document) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *documents.Document) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *documents.Document, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *documents.Document, is_create bool) error {
	var err error
	...
	if m.DocumentTypeID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "PayTo"
	if m.PayTo.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
	...
	ColumnName = "PayDeadline"
	if m.PayDeadline.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "BillKindID"
	if m.BillKindID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}
	...
	ColumnName = "PayFrom"
	if m.PayFrom.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "ReversalID"
	if m.ReversalID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}
...
func (crud Crud_DB) Delete(m *documents.Document) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *documents.Document) error {
	var err error
...
func (crud Crud_DB) Restore(m *documents.Document) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *documents.Document) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID(m *documents.Document) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID_ctx(ctx context.Context, m *documents.Document) error {
	var err error
