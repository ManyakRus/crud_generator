...
func (crud Crud_DB) Read(m *events.Event) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *events.Event) error {
	var err error
...
func (crud Crud_DB) Save(m *events.Event) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *events.Event) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *events.Event) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *events.Event) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *events.Event) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *events.Event) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *events.Event, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *events.Event, is_create bool) error {
	var err error
	...
	ColumnName = "RelativeNoticeAt"
	if m.RelativeNoticeAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "StartAt"
	if m.StartAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
...
func (crud Crud_DB) Delete(m *events.Event) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *events.Event) error {
	var err error
...
func (crud Crud_DB) Restore(m *events.Event) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *events.Event) error {
	var err error
