...
const TableName string = "facsimiles"
...
func (crud Crud_DB) Read(m *facsimiles.Facsimile) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *facsimiles.Facsimile) error {
	var err error
...
func (crud Crud_DB) Save(m *facsimiles.Facsimile) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *facsimiles.Facsimile) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *facsimiles.Facsimile) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *facsimiles.Facsimile) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *facsimiles.Facsimile) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *facsimiles.Facsimile) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *facsimiles.Facsimile, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *facsimiles.Facsimile, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *facsimiles.Facsimile) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *facsimiles.Facsimile) error {
	var err error
...
func (crud Crud_DB) Restore(m *facsimiles.Facsimile) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *facsimiles.Facsimile) error {
	var err error
