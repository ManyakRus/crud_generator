...
const TableName string = "file_templates"
...
func (crud Crud_DB) Read(m *file_templates.FileTemplate) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *file_templates.FileTemplate) error {
	var err error
...
func (crud Crud_DB) Save(m *file_templates.FileTemplate) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *file_templates.FileTemplate) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *file_templates.FileTemplate) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *file_templates.FileTemplate) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *file_templates.FileTemplate) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *file_templates.FileTemplate) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *file_templates.FileTemplate, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *file_templates.FileTemplate, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *file_templates.FileTemplate) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *file_templates.FileTemplate) error {
	var err error
	...
	m2 := file_templates.FileTemplate{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *file_templates.FileTemplate) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *file_templates.FileTemplate) error {
	var err error
