...
package db_invoice_debt_type_stats
...
const TableName string = "invoice_debt_type_stats"
...
func (crud Crud_DB) Read(m *invoice_debt_type_stats.InvoiceDebtTypeStat) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *invoice_debt_type_stats.InvoiceDebtTypeStat) error {
	var err error
...
func (crud Crud_DB) Save(m *invoice_debt_type_stats.InvoiceDebtTypeStat) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *invoice_debt_type_stats.InvoiceDebtTypeStat) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *invoice_debt_type_stats.InvoiceDebtTypeStat) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *invoice_debt_type_stats.InvoiceDebtTypeStat) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *invoice_debt_type_stats.InvoiceDebtTypeStat) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *invoice_debt_type_stats.InvoiceDebtTypeStat) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *invoice_debt_type_stats.InvoiceDebtTypeStat, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *invoice_debt_type_stats.InvoiceDebtTypeStat, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *invoice_debt_type_stats.InvoiceDebtTypeStat) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *invoice_debt_type_stats.InvoiceDebtTypeStat) error {
	var err error
	...
	m2 := invoice_debt_type_stats.InvoiceDebtTypeStat{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *invoice_debt_type_stats.InvoiceDebtTypeStat) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *invoice_debt_type_stats.InvoiceDebtTypeStat) error {
	var err error
