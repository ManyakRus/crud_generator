...
package db_lawsuit_stage_types
...
func (crud Crud_DB) Read(m *lawsuit_stage_types.LawsuitStageType) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *lawsuit_stage_types.LawsuitStageType) error {
	var err error
...
func (crud Crud_DB) Save(m *lawsuit_stage_types.LawsuitStageType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *lawsuit_stage_types.LawsuitStageType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *lawsuit_stage_types.LawsuitStageType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *lawsuit_stage_types.LawsuitStageType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *lawsuit_stage_types.LawsuitStageType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *lawsuit_stage_types.LawsuitStageType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *lawsuit_stage_types.LawsuitStageType, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *lawsuit_stage_types.LawsuitStageType, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *lawsuit_stage_types.LawsuitStageType) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *lawsuit_stage_types.LawsuitStageType) error {
	var err error
	...
	m2 := lawsuit_stage_types.LawsuitStageType{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *lawsuit_stage_types.LawsuitStageType) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *lawsuit_stage_types.LawsuitStageType) error {
	var err error
