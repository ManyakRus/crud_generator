...
const TableName string = "lawsuits"
...
func (crud Crud_DB) Read(m *lawsuits.Lawsuit) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *lawsuits.Lawsuit) error {
	var err error
...
func (crud Crud_DB) Save(m *lawsuits.Lawsuit) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *lawsuits.Lawsuit) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *lawsuits.Lawsuit) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *lawsuits.Lawsuit) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *lawsuits.Lawsuit) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *lawsuits.Lawsuit) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *lawsuits.Lawsuit, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *lawsuits.Lawsuit, is_create bool) error {
	var err error
	...
	ColumnName = "CuratorLegalID"
	if m.CuratorLegalID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "NotifyPretrialAt"
	if m.NotifyPretrialAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "CuratorPaymentID"
	if m.CuratorPaymentID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "PretrialAt"
	if m.PretrialAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
	...
	ColumnName = "ProcessStartedAt"
	if m.ProcessStartedAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "StatusAt"
	if m.StatusAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
	...
	ColumnName = "NotifyClaimAt"
	if m.NotifyClaimAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "CuratorContractID"
	if m.CuratorContractID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "CuratorTechAuditID"
	if m.CuratorTechAuditID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "ClaimAt"
	if m.ClaimAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
	...
	ColumnName = "StageAt"
	if m.StageAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "ControlledAt"
	if m.ControlledAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
...
func (crud Crud_DB) Delete(m *lawsuits.Lawsuit) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *lawsuits.Lawsuit) error {
	var err error
...
func (crud Crud_DB) Restore(m *lawsuits.Lawsuit) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *lawsuits.Lawsuit) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID(m *lawsuits.Lawsuit) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID_ctx(ctx context.Context, m *lawsuits.Lawsuit) error {
	var err error
