...
package db_message_send_statuses
...
func (crud Crud_DB) Read(m *message_send_statuses.MessageSendStatus) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *message_send_statuses.MessageSendStatus) error {
	var err error
...
func (crud Crud_DB) Save(m *message_send_statuses.MessageSendStatus) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *message_send_statuses.MessageSendStatus) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *message_send_statuses.MessageSendStatus) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *message_send_statuses.MessageSendStatus) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *message_send_statuses.MessageSendStatus) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *message_send_statuses.MessageSendStatus) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *message_send_statuses.MessageSendStatus, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *message_send_statuses.MessageSendStatus, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *message_send_statuses.MessageSendStatus) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *message_send_statuses.MessageSendStatus) error {
	var err error
	...
	m2 := message_send_statuses.MessageSendStatus{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *message_send_statuses.MessageSendStatus) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *message_send_statuses.MessageSendStatus) error {
	var err error
