...
func (crud Crud_DB) Read(m *messages.Message) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *messages.Message) error {
	var err error
...
func (crud Crud_DB) Save(m *messages.Message) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *messages.Message) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *messages.Message) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *messages.Message) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *messages.Message) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *messages.Message) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *messages.Message, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *messages.Message, is_create bool) error {
	var err error
	...
	ColumnName = "MessageFileID"
	if m.MessageFileID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "ReceivedAt"
	if m.ReceivedAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "DirectionTypeID"
	if m.DirectionTypeID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "EmployeeIdFrom"
	if m.EmployeeIdFrom == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "EmployeeIdTo"
	if m.EmployeeIdTo == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}
	...
	ColumnName = "SentAt"
	if m.SentAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "ChannelTypeID"
	if m.ChannelTypeID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}
...
func (crud Crud_DB) Delete(m *messages.Message) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *messages.Message) error {
	var err error
...
func (crud Crud_DB) Restore(m *messages.Message) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *messages.Message) error {
	var err error
