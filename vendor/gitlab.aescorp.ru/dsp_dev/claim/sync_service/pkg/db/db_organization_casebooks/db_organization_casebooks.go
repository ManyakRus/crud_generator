...
func (crud Crud_DB) Read(m *organization_casebooks.OrganizationCasebook) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *organization_casebooks.OrganizationCasebook) error {
	var err error
...
func (crud Crud_DB) Save(m *organization_casebooks.OrganizationCasebook) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *organization_casebooks.OrganizationCasebook) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *organization_casebooks.OrganizationCasebook) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *organization_casebooks.OrganizationCasebook) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *organization_casebooks.OrganizationCasebook) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *organization_casebooks.OrganizationCasebook) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *organization_casebooks.OrganizationCasebook, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *organization_casebooks.OrganizationCasebook, is_create bool) error {
	var err error
	...
	ColumnName = "JSONUpdatedAt"
	if m.JSONUpdatedAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
	...
	ColumnName = "PDFUpdatedAt"
	if m.PDFUpdatedAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
...
func (crud Crud_DB) Delete(m *organization_casebooks.OrganizationCasebook) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *organization_casebooks.OrganizationCasebook) error {
	var err error
	...
	m2 := organization_casebooks.OrganizationCasebook{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *organization_casebooks.OrganizationCasebook) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *organization_casebooks.OrganizationCasebook) error {
	var err error
