...
const TableName string = "organizations"
...
func (crud Crud_DB) Read(m *organizations.Organization) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *organizations.Organization) error {
	var err error
...
func (crud Crud_DB) Save(m *organizations.Organization) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *organizations.Organization) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *organizations.Organization) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *organizations.Organization) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *organizations.Organization) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *organizations.Organization) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *organizations.Organization, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *organizations.Organization, is_create bool) error {
	var err error
	...
	ColumnName = "LiquidateAt"
	if m.LiquidateAt.IsZero() == true {
	...
	ColumnName = "BankruptAt"
	if m.BankruptAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "RegistrationAt"
	if m.RegistrationAt.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
...
func (crud Crud_DB) Delete(m *organizations.Organization) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *organizations.Organization) error {
	var err error
...
func (crud Crud_DB) Restore(m *organizations.Organization) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *organizations.Organization) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID(m *organizations.Organization) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID_ctx(ctx context.Context, m *organizations.Organization) error {
	var err error
