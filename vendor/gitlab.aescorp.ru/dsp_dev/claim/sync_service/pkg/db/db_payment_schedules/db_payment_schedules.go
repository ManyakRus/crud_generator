...
const TableName string = "payment_schedules"
...
func (crud Crud_DB) Read(m *payment_schedules.PaymentSchedule) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *payment_schedules.PaymentSchedule) error {
	var err error
...
func (crud Crud_DB) Save(m *payment_schedules.PaymentSchedule) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *payment_schedules.PaymentSchedule) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *payment_schedules.PaymentSchedule) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *payment_schedules.PaymentSchedule) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *payment_schedules.PaymentSchedule) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *payment_schedules.PaymentSchedule) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *payment_schedules.PaymentSchedule, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *payment_schedules.PaymentSchedule, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *payment_schedules.PaymentSchedule) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *payment_schedules.PaymentSchedule) error {
	var err error
	...
	m2 := payment_schedules.PaymentSchedule{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *payment_schedules.PaymentSchedule) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *payment_schedules.PaymentSchedule) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID(m *payment_schedules.PaymentSchedule) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID_ctx(ctx context.Context, m *payment_schedules.PaymentSchedule) error {
	var err error
