...
package db_penalty_calculation_items
...
const TableName string = "penalty_calculation_items"
...
func (crud Crud_DB) Read(m *penalty_calculation_items.PenaltyCalculationItem) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *penalty_calculation_items.PenaltyCalculationItem) error {
	var err error
...
func (crud Crud_DB) Save(m *penalty_calculation_items.PenaltyCalculationItem) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *penalty_calculation_items.PenaltyCalculationItem) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *penalty_calculation_items.PenaltyCalculationItem) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *penalty_calculation_items.PenaltyCalculationItem) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *penalty_calculation_items.PenaltyCalculationItem) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *penalty_calculation_items.PenaltyCalculationItem) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *penalty_calculation_items.PenaltyCalculationItem, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *penalty_calculation_items.PenaltyCalculationItem, is_create bool) error {
	var err error
	...
	ColumnName = "AccrualTypeID"
	if m.AccrualTypeID == 0 {
	...
	ColumnName = "DocumentInvoiceID"
	if m.DocumentInvoiceID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "UsedMonth"
	if m.UsedMonth.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "BillingMonth"
	if m.BillingMonth.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}

	ColumnName = "DateTo"
	if m.DateTo.IsZero() == true {
		MassOmit = append(MassOmit, ColumnName)
	}
	...
	ColumnName = "DocumentPenaltyInvoiceID"
	if m.DocumentPenaltyInvoiceID == 0 {
		MassOmit = append(MassOmit, ColumnName)
	}
...
func (crud Crud_DB) Delete(m *penalty_calculation_items.PenaltyCalculationItem) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *penalty_calculation_items.PenaltyCalculationItem) error {
	var err error
	...
	m2 := penalty_calculation_items.PenaltyCalculationItem{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *penalty_calculation_items.PenaltyCalculationItem) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *penalty_calculation_items.PenaltyCalculationItem) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID(m *penalty_calculation_items.PenaltyCalculationItem) error {
	var err error
...
func (crud Crud_DB) Find_ByExtID_ctx(ctx context.Context, m *penalty_calculation_items.PenaltyCalculationItem) error {
	var err error
