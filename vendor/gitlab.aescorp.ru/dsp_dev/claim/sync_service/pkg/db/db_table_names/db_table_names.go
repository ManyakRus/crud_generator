...
const TableName string = "table_names"
...
func (crud Crud_DB) Read(m *table_names.TableName) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *table_names.TableName) error {
	var err error
...
func (crud Crud_DB) Save(m *table_names.TableName) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *table_names.TableName) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *table_names.TableName) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *table_names.TableName) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *table_names.TableName) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *table_names.TableName) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *table_names.TableName, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *table_names.TableName, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *table_names.TableName) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *table_names.TableName) error {
	var err error
...
func (crud Crud_DB) Restore(m *table_names.TableName) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *table_names.TableName) error {
	var err error
