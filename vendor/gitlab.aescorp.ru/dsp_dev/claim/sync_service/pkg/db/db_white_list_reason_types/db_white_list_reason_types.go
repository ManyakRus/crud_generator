...
package db_white_list_reason_types
...
const TableName string = "white_list_reason_types"
...
func (crud Crud_DB) Read(m *white_list_reason_types.WhiteListReasonType) error {
	var err error
...
func (crud Crud_DB) Read_ctx(ctx context.Context, m *white_list_reason_types.WhiteListReasonType) error {
	var err error
...
func (crud Crud_DB) Save(m *white_list_reason_types.WhiteListReasonType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Save_ctx(ctx context.Context, m *white_list_reason_types.WhiteListReasonType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *white_list_reason_types.WhiteListReasonType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Update_ctx(ctx context.Context, m *white_list_reason_types.WhiteListReasonType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *white_list_reason_types.WhiteListReasonType) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func (crud Crud_DB) Create_ctx(ctx context.Context, m *white_list_reason_types.WhiteListReasonType) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *white_list_reason_types.WhiteListReasonType, is_create bool) error {
	var err error
...
func (crud Crud_DB) create_update_ctx(ctx context.Context, m *white_list_reason_types.WhiteListReasonType, is_create bool) error {
	var err error
...
func (crud Crud_DB) Delete(m *white_list_reason_types.WhiteListReasonType) error {
	var err error
...
func (crud Crud_DB) Delete_ctx(ctx context.Context, m *white_list_reason_types.WhiteListReasonType) error {
	var err error
	...
	m2 := white_list_reason_types.WhiteListReasonType{}
	m2.ID = m.ID
...
func (crud Crud_DB) Restore(m *white_list_reason_types.WhiteListReasonType) error {
	var err error
...
func (crud Crud_DB) Restore_ctx(ctx context.Context, m *white_list_reason_types.WhiteListReasonType) error {
	var err error
