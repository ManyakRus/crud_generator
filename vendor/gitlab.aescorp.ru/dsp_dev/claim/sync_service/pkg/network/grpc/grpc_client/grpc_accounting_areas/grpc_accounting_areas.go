...
func (crud Crud_GRPC) Read(m *accounting_areas.AccountingArea) error {
	...
	// запрос
	Response, err := grpc_client.Client.AccountingArea_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *accounting_areas.AccountingArea) error {
	// var Otvet accounting_areas.AccountingArea
	...
	// запрос
	Response, err := grpc_client.Client.AccountingArea_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *accounting_areas.AccountingArea) error {
	// var Otvet accounting_areas.AccountingArea
	...
	// запрос
	Response, err := grpc_client.Client.AccountingArea_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *accounting_areas.AccountingArea) error {
	// var Otvet accounting_areas.AccountingArea
	...
	// запрос
	Response, err := grpc_client.Client.AccountingArea_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *accounting_areas.AccountingArea) error {
	// var Otvet accounting_areas.AccountingArea
	...
	// запрос
	Response, err := grpc_client.Client.AccountingArea_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *accounting_areas.AccountingArea) error {
	// var Otvet accounting_areas.AccountingArea
	...
	// запрос
	Response, err := grpc_client.Client.AccountingArea_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Find_ByExtID(m *accounting_areas.AccountingArea) error {
	//подключение
	if grpc_client.Client == nil {
		grpc_client.Connect()
	}
	...
	//запрос
	Response, err := grpc_client.Client.AccountingArea_FindByExtID(ctx, Request)
	if err != nil {
		sError := err.Error()
