...
func (crud Crud_GRPC) Read(m *accrual_types.AccrualType) error {
	...
	// запрос
	Response, err := grpc_client.Client.AccrualType_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *accrual_types.AccrualType) error {
	// var Otvet accrual_types.AccrualType
	...
	// запрос
	Response, err := grpc_client.Client.AccrualType_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *accrual_types.AccrualType) error {
	// var Otvet accrual_types.AccrualType
	...
	// запрос
	Response, err := grpc_client.Client.AccrualType_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *accrual_types.AccrualType) error {
	// var Otvet accrual_types.AccrualType
	...
	// запрос
	Response, err := grpc_client.Client.AccrualType_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *accrual_types.AccrualType) error {
	// var Otvet accrual_types.AccrualType
	...
	// запрос
	Response, err := grpc_client.Client.AccrualType_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *accrual_types.AccrualType) error {
	// var Otvet accrual_types.AccrualType
	...
	// запрос
	Response, err := grpc_client.Client.AccrualType_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
