...
package grpc_bank_account_organizations
...
func (crud Crud_GRPC) GetVersionModel() uint32 {
	if VersionModel == 0 {
		VersionModel = bank_account_organizations.BankAccountOrganization{}.GetStructVersion()
	}
	return VersionModel
}

// Read - возвращает модель из БД
func (crud Crud_GRPC) Read(m *bank_account_organizations.BankAccountOrganization) error {
	// var Otvet bank_account_organizations.BankAccountOrganization
	...
	// запрос
	Response, err := grpc_client.Client.BankAccountOrganization_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *bank_account_organizations.BankAccountOrganization) error {
	// var Otvet bank_account_organizations.BankAccountOrganization
	...
	// запрос
	Response, err := grpc_client.Client.BankAccountOrganization_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *bank_account_organizations.BankAccountOrganization) error {
	// var Otvet bank_account_organizations.BankAccountOrganization
	...
	// запрос
	Response, err := grpc_client.Client.BankAccountOrganization_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *bank_account_organizations.BankAccountOrganization) error {
	// var Otvet bank_account_organizations.BankAccountOrganization
	...
	// запрос
	Response, err := grpc_client.Client.BankAccountOrganization_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *bank_account_organizations.BankAccountOrganization) error {
	// var Otvet bank_account_organizations.BankAccountOrganization
	...
	// запрос
	Response, err := grpc_client.Client.BankAccountOrganization_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *bank_account_organizations.BankAccountOrganization) error {
	// var Otvet bank_account_organizations.BankAccountOrganization
	...
	// запрос
	Response, err := grpc_client.Client.BankAccountOrganization_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Find_ByExtID(m *bank_account_organizations.BankAccountOrganization) error {
	//подключение
	if grpc_client.Client == nil {
		grpc_client.Connect()
	}
	...
	//запрос
	Response, err := grpc_client.Client.BankAccountOrganization_FindByExtID(ctx, Request)
	if err != nil {
		sError := err.Error()
