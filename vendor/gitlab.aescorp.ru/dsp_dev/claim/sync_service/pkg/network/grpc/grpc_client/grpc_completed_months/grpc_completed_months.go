...
func (crud Crud_GRPC) GetVersionModel() uint32 {
	if VersionModel == 0 {
		VersionModel = completed_months.CompletedMonth{}.GetStructVersion()
	}
	return VersionModel
}

// Read - возвращает модель из БД
func (crud Crud_GRPC) Read(m *completed_months.CompletedMonth) error {
	// var Otvet completed_months.CompletedMonth
	...
	// запрос
	Response, err := grpc_client.Client.CompletedMonth_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *completed_months.CompletedMonth) error {
	// var Otvet completed_months.CompletedMonth
	...
	// запрос
	Response, err := grpc_client.Client.CompletedMonth_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *completed_months.CompletedMonth) error {
	// var Otvet completed_months.CompletedMonth
	...
	// запрос
	Response, err := grpc_client.Client.CompletedMonth_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *completed_months.CompletedMonth) error {
	// var Otvet completed_months.CompletedMonth
	...
	// запрос
	Response, err := grpc_client.Client.CompletedMonth_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *completed_months.CompletedMonth) error {
	// var Otvet completed_months.CompletedMonth
	...
	// запрос
	Response, err := grpc_client.Client.CompletedMonth_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *completed_months.CompletedMonth) error {
	// var Otvet completed_months.CompletedMonth
	...
	// запрос
	Response, err := grpc_client.Client.CompletedMonth_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Find_ByExtID(m *completed_months.CompletedMonth) error {
	//подключение
	if grpc_client.Client == nil {
		grpc_client.Connect()
	}
	...
	//запрос
	Response, err := grpc_client.Client.CompletedMonth_FindByExtID(ctx, Request)
	if err != nil {
		sError := err.Error()
