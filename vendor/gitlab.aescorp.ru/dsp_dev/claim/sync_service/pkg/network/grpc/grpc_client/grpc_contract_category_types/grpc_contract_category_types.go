...
package grpc_contract_category_types
...
func (crud Crud_GRPC) Read(m *contract_category_types.ContractCategoryType) error {
	...
	// запрос
	Response, err := grpc_client.Client.ContractCategoryType_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *contract_category_types.ContractCategoryType) error {
	// var Otvet contract_category_types.ContractCategoryType
	...
	// запрос
	Response, err := grpc_client.Client.ContractCategoryType_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *contract_category_types.ContractCategoryType) error {
	// var Otvet contract_category_types.ContractCategoryType
	...
	// запрос
	Response, err := grpc_client.Client.ContractCategoryType_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *contract_category_types.ContractCategoryType) error {
	// var Otvet contract_category_types.ContractCategoryType
	...
	// запрос
	Response, err := grpc_client.Client.ContractCategoryType_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *contract_category_types.ContractCategoryType) error {
	// var Otvet contract_category_types.ContractCategoryType
	...
	// запрос
	Response, err := grpc_client.Client.ContractCategoryType_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *contract_category_types.ContractCategoryType) error {
	// var Otvet contract_category_types.ContractCategoryType
	...
	// запрос
	Response, err := grpc_client.Client.ContractCategoryType_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Find_ByExtID(m *contract_category_types.ContractCategoryType) error {
	//подключение
	if grpc_client.Client == nil {
		grpc_client.Connect()
	}
	...
	//запрос
	Response, err := grpc_client.Client.ContractCategoryType_FindByExtID(ctx, Request)
	if err != nil {
		sError := err.Error()
