...
package grpc_contract_white_items
...
func (crud Crud_GRPC) GetVersionModel() uint32 {
	if VersionModel == 0 {
		VersionModel = contract_white_items.ContractWhiteItem{}.GetStructVersion()
	}
	return VersionModel
}

// Read - возвращает модель из БД
func (crud Crud_GRPC) Read(m *contract_white_items.ContractWhiteItem) error {
	// var Otvet contract_white_items.ContractWhiteItem
	...
	// запрос
	Response, err := grpc_client.Client.ContractWhiteItem_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *contract_white_items.ContractWhiteItem) error {
	// var Otvet contract_white_items.ContractWhiteItem
	...
	// запрос
	Response, err := grpc_client.Client.ContractWhiteItem_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *contract_white_items.ContractWhiteItem) error {
	// var Otvet contract_white_items.ContractWhiteItem
	...
	// запрос
	Response, err := grpc_client.Client.ContractWhiteItem_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *contract_white_items.ContractWhiteItem) error {
	// var Otvet contract_white_items.ContractWhiteItem
	...
	// запрос
	Response, err := grpc_client.Client.ContractWhiteItem_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *contract_white_items.ContractWhiteItem) error {
	// var Otvet contract_white_items.ContractWhiteItem
	...
	// запрос
	Response, err := grpc_client.Client.ContractWhiteItem_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *contract_white_items.ContractWhiteItem) error {
	// var Otvet contract_white_items.ContractWhiteItem
	...
	// запрос
	Response, err := grpc_client.Client.ContractWhiteItem_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
