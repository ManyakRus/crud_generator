...
func (crud Crud_GRPC) Read(m *document_links.DocumentLink) error {
	...
	// запрос
	Response, err := grpc_client.Client.DocumentLink_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *document_links.DocumentLink) error {
	// var Otvet document_links.DocumentLink
	...
	// запрос
	Response, err := grpc_client.Client.DocumentLink_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *document_links.DocumentLink) error {
	// var Otvet document_links.DocumentLink
	...
	// запрос
	Response, err := grpc_client.Client.DocumentLink_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *document_links.DocumentLink) error {
	// var Otvet document_links.DocumentLink
	...
	// запрос
	Response, err := grpc_client.Client.DocumentLink_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *document_links.DocumentLink) error {
	// var Otvet document_links.DocumentLink
	...
	// запрос
	Response, err := grpc_client.Client.DocumentLink_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *document_links.DocumentLink) error {
	// var Otvet document_links.DocumentLink
	...
	// запрос
	Response, err := grpc_client.Client.DocumentLink_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Find_ByExtID(m *document_links.DocumentLink) error {
	//подключение
	if grpc_client.Client == nil {
		grpc_client.Connect()
	}
	...
	//запрос
	Response, err := grpc_client.Client.DocumentLink_FindByExtID(ctx, Request)
	if err != nil {
		sError := err.Error()
