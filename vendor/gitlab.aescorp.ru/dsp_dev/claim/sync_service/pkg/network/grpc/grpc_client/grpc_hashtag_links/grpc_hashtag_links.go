...
func (crud Crud_GRPC) GetVersionModel() uint32 {
	if VersionModel == 0 {
		VersionModel = hashtag_links.HashtagLink{}.GetStructVersion()
	}
	return VersionModel
}

// Read - возвращает модель из БД
func (crud Crud_GRPC) Read(m *hashtag_links.HashtagLink) error {
	// var Otvet hashtag_links.HashtagLink
	...
	// запрос
	Response, err := grpc_client.Client.HashtagLink_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *hashtag_links.HashtagLink) error {
	// var Otvet hashtag_links.HashtagLink
	...
	// запрос
	Response, err := grpc_client.Client.HashtagLink_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *hashtag_links.HashtagLink) error {
	// var Otvet hashtag_links.HashtagLink
	...
	// запрос
	Response, err := grpc_client.Client.HashtagLink_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *hashtag_links.HashtagLink) error {
	// var Otvet hashtag_links.HashtagLink
	...
	// запрос
	Response, err := grpc_client.Client.HashtagLink_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *hashtag_links.HashtagLink) error {
	// var Otvet hashtag_links.HashtagLink
	...
	// запрос
	Response, err := grpc_client.Client.HashtagLink_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *hashtag_links.HashtagLink) error {
	// var Otvet hashtag_links.HashtagLink
	...
	// запрос
	Response, err := grpc_client.Client.HashtagLink_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
