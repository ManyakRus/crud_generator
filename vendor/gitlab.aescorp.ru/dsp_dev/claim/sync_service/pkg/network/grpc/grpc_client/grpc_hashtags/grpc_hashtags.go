...
func (crud Crud_GRPC) Read(m *hashtags.Hashtag) error {
	...
	// запрос
	Response, err := grpc_client.Client.Hashtag_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *hashtags.Hashtag) error {
	// var Otvet hashtags.Hashtag
	...
	// запрос
	Response, err := grpc_client.Client.Hashtag_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *hashtags.Hashtag) error {
	// var Otvet hashtags.Hashtag
	...
	// запрос
	Response, err := grpc_client.Client.Hashtag_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *hashtags.Hashtag) error {
	// var Otvet hashtags.Hashtag
	...
	// запрос
	Response, err := grpc_client.Client.Hashtag_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *hashtags.Hashtag) error {
	// var Otvet hashtags.Hashtag
	...
	// запрос
	Response, err := grpc_client.Client.Hashtag_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *hashtags.Hashtag) error {
	// var Otvet hashtags.Hashtag
	...
	// запрос
	Response, err := grpc_client.Client.Hashtag_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
