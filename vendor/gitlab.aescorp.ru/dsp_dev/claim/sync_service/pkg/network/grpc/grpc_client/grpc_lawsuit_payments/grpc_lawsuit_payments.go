...
func (crud Crud_GRPC) GetVersionModel() uint32 {
	if VersionModel == 0 {
		VersionModel = lawsuit_payments.LawsuitPayment{}.GetStructVersion()
	}
	return VersionModel
}

// Read - возвращает модель из БД
func (crud Crud_GRPC) Read(m *lawsuit_payments.LawsuitPayment) error {
	// var Otvet lawsuit_payments.LawsuitPayment
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitPayment_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *lawsuit_payments.LawsuitPayment) error {
	// var Otvet lawsuit_payments.LawsuitPayment
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitPayment_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *lawsuit_payments.LawsuitPayment) error {
	// var Otvet lawsuit_payments.LawsuitPayment
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitPayment_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *lawsuit_payments.LawsuitPayment) error {
	// var Otvet lawsuit_payments.LawsuitPayment
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitPayment_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *lawsuit_payments.LawsuitPayment) error {
	// var Otvet lawsuit_payments.LawsuitPayment
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitPayment_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *lawsuit_payments.LawsuitPayment) error {
	// var Otvet lawsuit_payments.LawsuitPayment
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitPayment_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
