...
package grpc_lawsuit_reason_types
...
func (crud Crud_GRPC) GetVersionModel() uint32 {
	if VersionModel == 0 {
		VersionModel = lawsuit_reason_types.LawsuitReasonType{}.GetStructVersion()
	}
	return VersionModel
}

// Read - возвращает модель из БД
func (crud Crud_GRPC) Read(m *lawsuit_reason_types.LawsuitReasonType) error {
	// var Otvet lawsuit_reason_types.LawsuitReasonType
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitReasonType_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *lawsuit_reason_types.LawsuitReasonType) error {
	// var Otvet lawsuit_reason_types.LawsuitReasonType
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitReasonType_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *lawsuit_reason_types.LawsuitReasonType) error {
	// var Otvet lawsuit_reason_types.LawsuitReasonType
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitReasonType_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *lawsuit_reason_types.LawsuitReasonType) error {
	// var Otvet lawsuit_reason_types.LawsuitReasonType
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitReasonType_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *lawsuit_reason_types.LawsuitReasonType) error {
	// var Otvet lawsuit_reason_types.LawsuitReasonType
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitReasonType_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *lawsuit_reason_types.LawsuitReasonType) error {
	// var Otvet lawsuit_reason_types.LawsuitReasonType
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitReasonType_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
