...
package grpc_lawsuit_stage_types
...
func (crud Crud_GRPC) Read(m *lawsuit_stage_types.LawsuitStageType) error {
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitStageType_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *lawsuit_stage_types.LawsuitStageType) error {
	// var Otvet lawsuit_stage_types.LawsuitStageType
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitStageType_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *lawsuit_stage_types.LawsuitStageType) error {
	// var Otvet lawsuit_stage_types.LawsuitStageType
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitStageType_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *lawsuit_stage_types.LawsuitStageType) error {
	// var Otvet lawsuit_stage_types.LawsuitStageType
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitStageType_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *lawsuit_stage_types.LawsuitStageType) error {
	// var Otvet lawsuit_stage_types.LawsuitStageType
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitStageType_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *lawsuit_stage_types.LawsuitStageType) error {
	// var Otvet lawsuit_stage_types.LawsuitStageType
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitStageType_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
