...
func (crud Crud_GRPC) GetVersionModel() uint32 {
	if VersionModel == 0 {
		VersionModel = lawsuit_status_states.LawsuitStatusState{}.GetStructVersion()
	}
	return VersionModel
}

// Read - возвращает модель из БД
func (crud Crud_GRPC) Read(m *lawsuit_status_states.LawsuitStatusState) error {
	// var Otvet lawsuit_status_states.LawsuitStatusState
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitStatusState_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *lawsuit_status_states.LawsuitStatusState) error {
	// var Otvet lawsuit_status_states.LawsuitStatusState
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitStatusState_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *lawsuit_status_states.LawsuitStatusState) error {
	// var Otvet lawsuit_status_states.LawsuitStatusState
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitStatusState_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *lawsuit_status_states.LawsuitStatusState) error {
	// var Otvet lawsuit_status_states.LawsuitStatusState
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitStatusState_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *lawsuit_status_states.LawsuitStatusState) error {
	// var Otvet lawsuit_status_states.LawsuitStatusState
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitStatusState_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *lawsuit_status_states.LawsuitStatusState) error {
	// var Otvet lawsuit_status_states.LawsuitStatusState
	...
	// запрос
	Response, err := grpc_client.Client.LawsuitStatusState_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
