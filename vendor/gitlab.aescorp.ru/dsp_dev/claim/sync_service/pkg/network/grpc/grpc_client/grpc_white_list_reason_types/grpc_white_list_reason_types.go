...
package grpc_white_list_reason_types
...
func (crud Crud_GRPC) GetVersionModel() uint32 {
	if VersionModel == 0 {
		VersionModel = white_list_reason_types.WhiteListReasonType{}.GetStructVersion()
	}
	return VersionModel
}

// Read - возвращает модель из БД
func (crud Crud_GRPC) Read(m *white_list_reason_types.WhiteListReasonType) error {
	// var Otvet white_list_reason_types.WhiteListReasonType
	...
	// запрос
	Response, err := grpc_client.Client.WhiteListReasonType_Read(ctx, Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_GRPC) Create(m *white_list_reason_types.WhiteListReasonType) error {
	// var Otvet white_list_reason_types.WhiteListReasonType
	...
	// запрос
	Response, err := grpc_client.Client.WhiteListReasonType_Create(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Update(m *white_list_reason_types.WhiteListReasonType) error {
	// var Otvet white_list_reason_types.WhiteListReasonType
	...
	// запрос
	Response, err := grpc_client.Client.WhiteListReasonType_Update(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Save(m *white_list_reason_types.WhiteListReasonType) error {
	// var Otvet white_list_reason_types.WhiteListReasonType
	...
	// запрос
	Response, err := grpc_client.Client.WhiteListReasonType_Save(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Delete(m *white_list_reason_types.WhiteListReasonType) error {
	// var Otvet white_list_reason_types.WhiteListReasonType
	...
	// запрос
	Response, err := grpc_client.Client.WhiteListReasonType_Delete(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_GRPC) Restore(m *white_list_reason_types.WhiteListReasonType) error {
	// var Otvet white_list_reason_types.WhiteListReasonType
	...
	// запрос
	Response, err := grpc_client.Client.WhiteListReasonType_Restore(ctx, Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
