...
func (crud Crud_NRPC) Read(m *change_items.ChangeItem) error {
	...
	// запрос
	Response, err := nrpc_client.Client.ChangeItem_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *change_items.ChangeItem) error {
	// var Otvet change_items.ChangeItem
	...
	// запрос
	Response, err := nrpc_client.Client.ChangeItem_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *change_items.ChangeItem) error {
	// var Otvet change_items.ChangeItem
	...
	// запрос
	Response, err := nrpc_client.Client.ChangeItem_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *change_items.ChangeItem) error {
	// var Otvet change_items.ChangeItem
	...
	// запрос
	Response, err := nrpc_client.Client.ChangeItem_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *change_items.ChangeItem) error {
	// var Otvet change_items.ChangeItem
	...
	// запрос
	Response, err := nrpc_client.Client.ChangeItem_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *change_items.ChangeItem) error {
	// var Otvet change_items.ChangeItem
	...
	// запрос
	Response, err := nrpc_client.Client.ChangeItem_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
