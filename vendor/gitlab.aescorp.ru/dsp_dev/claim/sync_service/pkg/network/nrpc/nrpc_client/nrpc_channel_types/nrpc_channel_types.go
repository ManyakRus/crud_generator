...
func (crud Crud_NRPC) Read(m *channel_types.ChannelType) error {
	...
	// запрос
	Response, err := nrpc_client.Client.ChannelType_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *channel_types.ChannelType) error {
	// var Otvet channel_types.ChannelType
	...
	// запрос
	Response, err := nrpc_client.Client.ChannelType_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *channel_types.ChannelType) error {
	// var Otvet channel_types.ChannelType
	...
	// запрос
	Response, err := nrpc_client.Client.ChannelType_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *channel_types.ChannelType) error {
	// var Otvet channel_types.ChannelType
	...
	// запрос
	Response, err := nrpc_client.Client.ChannelType_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *channel_types.ChannelType) error {
	// var Otvet channel_types.ChannelType
	...
	// запрос
	Response, err := nrpc_client.Client.ChannelType_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *channel_types.ChannelType) error {
	// var Otvet channel_types.ChannelType
	...
	// запрос
	Response, err := nrpc_client.Client.ChannelType_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
