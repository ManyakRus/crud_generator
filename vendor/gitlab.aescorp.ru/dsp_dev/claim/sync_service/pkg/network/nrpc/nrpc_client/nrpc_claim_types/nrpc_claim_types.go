...
func (crud Crud_NRPC) Read(m *claim_types.ClaimType) error {
	...
	// запрос
	Response, err := nrpc_client.Client.ClaimType_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *claim_types.ClaimType) error {
	// var Otvet claim_types.ClaimType
	...
	// запрос
	Response, err := nrpc_client.Client.ClaimType_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *claim_types.ClaimType) error {
	// var Otvet claim_types.ClaimType
	...
	// запрос
	Response, err := nrpc_client.Client.ClaimType_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *claim_types.ClaimType) error {
	// var Otvet claim_types.ClaimType
	...
	// запрос
	Response, err := nrpc_client.Client.ClaimType_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *claim_types.ClaimType) error {
	// var Otvet claim_types.ClaimType
	...
	// запрос
	Response, err := nrpc_client.Client.ClaimType_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *claim_types.ClaimType) error {
	// var Otvet claim_types.ClaimType
	...
	// запрос
	Response, err := nrpc_client.Client.ClaimType_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
