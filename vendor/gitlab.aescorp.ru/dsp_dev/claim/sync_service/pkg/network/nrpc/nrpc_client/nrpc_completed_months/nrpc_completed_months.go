...
func (crud Crud_NRPC) Read(m *completed_months.CompletedMonth) error {
	...
	// запрос
	Response, err := nrpc_client.Client.CompletedMonth_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *completed_months.CompletedMonth) error {
	// var Otvet completed_months.CompletedMonth
	...
	// запрос
	Response, err := nrpc_client.Client.CompletedMonth_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *completed_months.CompletedMonth) error {
	// var Otvet completed_months.CompletedMonth
	...
	// запрос
	Response, err := nrpc_client.Client.CompletedMonth_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *completed_months.CompletedMonth) error {
	// var Otvet completed_months.CompletedMonth
	...
	// запрос
	Response, err := nrpc_client.Client.CompletedMonth_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *completed_months.CompletedMonth) error {
	// var Otvet completed_months.CompletedMonth
	...
	// запрос
	Response, err := nrpc_client.Client.CompletedMonth_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *completed_months.CompletedMonth) error {
	// var Otvet completed_months.CompletedMonth
	...
	// запрос
	Response, err := nrpc_client.Client.CompletedMonth_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Find_ByExtID(m *completed_months.CompletedMonth) error {
	//подключение
	if nrpc_client.Client == nil {
		nrpc_client.Connect()
	}
	...
	//запрос
	Response, err := nrpc_client.Client.CompletedMonth_FindByExtID(Request)
	if err != nil {
		sError := err.Error()
