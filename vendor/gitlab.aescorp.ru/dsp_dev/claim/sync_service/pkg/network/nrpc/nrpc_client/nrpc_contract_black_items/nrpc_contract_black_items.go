...
package nrpc_contract_black_items
...
func (crud Crud_NRPC) Read(m *contract_black_items.ContractBlackItem) error {
	...
	// запрос
	Response, err := nrpc_client.Client.ContractBlackItem_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *contract_black_items.ContractBlackItem) error {
	// var Otvet contract_black_items.ContractBlackItem
	...
	// запрос
	Response, err := nrpc_client.Client.ContractBlackItem_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *contract_black_items.ContractBlackItem) error {
	// var Otvet contract_black_items.ContractBlackItem
	...
	// запрос
	Response, err := nrpc_client.Client.ContractBlackItem_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *contract_black_items.ContractBlackItem) error {
	// var Otvet contract_black_items.ContractBlackItem
	...
	// запрос
	Response, err := nrpc_client.Client.ContractBlackItem_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *contract_black_items.ContractBlackItem) error {
	// var Otvet contract_black_items.ContractBlackItem
	...
	// запрос
	Response, err := nrpc_client.Client.ContractBlackItem_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *contract_black_items.ContractBlackItem) error {
	// var Otvet contract_black_items.ContractBlackItem
	...
	// запрос
	Response, err := nrpc_client.Client.ContractBlackItem_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
