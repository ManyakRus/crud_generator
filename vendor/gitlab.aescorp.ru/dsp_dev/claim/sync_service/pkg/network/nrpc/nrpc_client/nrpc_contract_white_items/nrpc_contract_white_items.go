...
package nrpc_contract_white_items
...
func (crud Crud_NRPC) Read(m *contract_white_items.ContractWhiteItem) error {
	...
	// запрос
	Response, err := nrpc_client.Client.ContractWhiteItem_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *contract_white_items.ContractWhiteItem) error {
	// var Otvet contract_white_items.ContractWhiteItem
	...
	// запрос
	Response, err := nrpc_client.Client.ContractWhiteItem_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *contract_white_items.ContractWhiteItem) error {
	// var Otvet contract_white_items.ContractWhiteItem
	...
	// запрос
	Response, err := nrpc_client.Client.ContractWhiteItem_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *contract_white_items.ContractWhiteItem) error {
	// var Otvet contract_white_items.ContractWhiteItem
	...
	// запрос
	Response, err := nrpc_client.Client.ContractWhiteItem_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *contract_white_items.ContractWhiteItem) error {
	// var Otvet contract_white_items.ContractWhiteItem
	...
	// запрос
	Response, err := nrpc_client.Client.ContractWhiteItem_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *contract_white_items.ContractWhiteItem) error {
	// var Otvet contract_white_items.ContractWhiteItem
	...
	// запрос
	Response, err := nrpc_client.Client.ContractWhiteItem_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
