...
func (crud Crud_NRPC) Read(m *document_types.DocumentType) error {
	...
	// запрос
	Response, err := nrpc_client.Client.DocumentType_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *document_types.DocumentType) error {
	// var Otvet document_types.DocumentType
	...
	// запрос
	Response, err := nrpc_client.Client.DocumentType_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *document_types.DocumentType) error {
	// var Otvet document_types.DocumentType
	...
	// запрос
	Response, err := nrpc_client.Client.DocumentType_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *document_types.DocumentType) error {
	// var Otvet document_types.DocumentType
	...
	// запрос
	Response, err := nrpc_client.Client.DocumentType_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *document_types.DocumentType) error {
	// var Otvet document_types.DocumentType
	...
	// запрос
	Response, err := nrpc_client.Client.DocumentType_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *document_types.DocumentType) error {
	// var Otvet document_types.DocumentType
	...
	// запрос
	Response, err := nrpc_client.Client.DocumentType_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Find_ByExtID(m *document_types.DocumentType) error {
	//подключение
	if nrpc_client.Client == nil {
		nrpc_client.Connect()
	}
	...
	//запрос
	Response, err := nrpc_client.Client.DocumentType_FindByExtID(Request)
	if err != nil {
		sError := err.Error()
