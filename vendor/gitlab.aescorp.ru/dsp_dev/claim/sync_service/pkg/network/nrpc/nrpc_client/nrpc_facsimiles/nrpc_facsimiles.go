...
func (crud Crud_NRPC) Read(m *facsimiles.Facsimile) error {
	...
	// запрос
	Response, err := nrpc_client.Client.Facsimile_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *facsimiles.Facsimile) error {
	// var Otvet facsimiles.Facsimile
	...
	// запрос
	Response, err := nrpc_client.Client.Facsimile_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *facsimiles.Facsimile) error {
	// var Otvet facsimiles.Facsimile
	...
	// запрос
	Response, err := nrpc_client.Client.Facsimile_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *facsimiles.Facsimile) error {
	// var Otvet facsimiles.Facsimile
	...
	// запрос
	Response, err := nrpc_client.Client.Facsimile_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *facsimiles.Facsimile) error {
	// var Otvet facsimiles.Facsimile
	...
	// запрос
	Response, err := nrpc_client.Client.Facsimile_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *facsimiles.Facsimile) error {
	// var Otvet facsimiles.Facsimile
	...
	// запрос
	Response, err := nrpc_client.Client.Facsimile_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
