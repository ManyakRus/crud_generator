...
func (crud Crud_NRPC) Read(m *file_templates.FileTemplate) error {
	...
	// запрос
	Response, err := nrpc_client.Client.FileTemplate_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *file_templates.FileTemplate) error {
	// var Otvet file_templates.FileTemplate
	...
	// запрос
	Response, err := nrpc_client.Client.FileTemplate_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *file_templates.FileTemplate) error {
	// var Otvet file_templates.FileTemplate
	...
	// запрос
	Response, err := nrpc_client.Client.FileTemplate_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *file_templates.FileTemplate) error {
	// var Otvet file_templates.FileTemplate
	...
	// запрос
	Response, err := nrpc_client.Client.FileTemplate_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *file_templates.FileTemplate) error {
	// var Otvet file_templates.FileTemplate
	...
	// запрос
	Response, err := nrpc_client.Client.FileTemplate_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *file_templates.FileTemplate) error {
	// var Otvet file_templates.FileTemplate
	...
	// запрос
	Response, err := nrpc_client.Client.FileTemplate_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
