...
func (crud Crud_NRPC) Read(m *gender_types.GenderType) error {
	...
	// запрос
	Response, err := nrpc_client.Client.GenderType_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *gender_types.GenderType) error {
	// var Otvet gender_types.GenderType
	...
	// запрос
	Response, err := nrpc_client.Client.GenderType_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *gender_types.GenderType) error {
	// var Otvet gender_types.GenderType
	...
	// запрос
	Response, err := nrpc_client.Client.GenderType_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *gender_types.GenderType) error {
	// var Otvet gender_types.GenderType
	...
	// запрос
	Response, err := nrpc_client.Client.GenderType_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *gender_types.GenderType) error {
	// var Otvet gender_types.GenderType
	...
	// запрос
	Response, err := nrpc_client.Client.GenderType_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *gender_types.GenderType) error {
	// var Otvet gender_types.GenderType
	...
	// запрос
	Response, err := nrpc_client.Client.GenderType_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
