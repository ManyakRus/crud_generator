...
func (crud Crud_NRPC) Read(m *lawsuit_invoices.LawsuitInvoice) error {
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitInvoice_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *lawsuit_invoices.LawsuitInvoice) error {
	// var Otvet lawsuit_invoices.LawsuitInvoice
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitInvoice_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *lawsuit_invoices.LawsuitInvoice) error {
	// var Otvet lawsuit_invoices.LawsuitInvoice
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitInvoice_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *lawsuit_invoices.LawsuitInvoice) error {
	// var Otvet lawsuit_invoices.LawsuitInvoice
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitInvoice_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *lawsuit_invoices.LawsuitInvoice) error {
	// var Otvet lawsuit_invoices.LawsuitInvoice
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitInvoice_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *lawsuit_invoices.LawsuitInvoice) error {
	// var Otvet lawsuit_invoices.LawsuitInvoice
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitInvoice_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
