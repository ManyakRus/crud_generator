...
func (crud Crud_NRPC) Read(m *lawsuit_payments.LawsuitPayment) error {
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitPayment_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *lawsuit_payments.LawsuitPayment) error {
	// var Otvet lawsuit_payments.LawsuitPayment
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitPayment_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *lawsuit_payments.LawsuitPayment) error {
	// var Otvet lawsuit_payments.LawsuitPayment
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitPayment_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *lawsuit_payments.LawsuitPayment) error {
	// var Otvet lawsuit_payments.LawsuitPayment
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitPayment_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *lawsuit_payments.LawsuitPayment) error {
	// var Otvet lawsuit_payments.LawsuitPayment
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitPayment_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *lawsuit_payments.LawsuitPayment) error {
	// var Otvet lawsuit_payments.LawsuitPayment
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitPayment_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
