...
package nrpc_lawsuit_reason_types
...
func (crud Crud_NRPC) Read(m *lawsuit_reason_types.LawsuitReasonType) error {
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitReasonType_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *lawsuit_reason_types.LawsuitReasonType) error {
	// var Otvet lawsuit_reason_types.LawsuitReasonType
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitReasonType_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *lawsuit_reason_types.LawsuitReasonType) error {
	// var Otvet lawsuit_reason_types.LawsuitReasonType
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitReasonType_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *lawsuit_reason_types.LawsuitReasonType) error {
	// var Otvet lawsuit_reason_types.LawsuitReasonType
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitReasonType_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *lawsuit_reason_types.LawsuitReasonType) error {
	// var Otvet lawsuit_reason_types.LawsuitReasonType
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitReasonType_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *lawsuit_reason_types.LawsuitReasonType) error {
	// var Otvet lawsuit_reason_types.LawsuitReasonType
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitReasonType_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
