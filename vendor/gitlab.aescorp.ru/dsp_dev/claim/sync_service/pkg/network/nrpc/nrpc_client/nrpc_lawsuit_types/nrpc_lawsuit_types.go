...
func (crud Crud_NRPC) Read(m *lawsuit_types.LawsuitType) error {
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitType_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *lawsuit_types.LawsuitType) error {
	// var Otvet lawsuit_types.LawsuitType
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitType_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *lawsuit_types.LawsuitType) error {
	// var Otvet lawsuit_types.LawsuitType
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitType_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *lawsuit_types.LawsuitType) error {
	// var Otvet lawsuit_types.LawsuitType
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitType_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *lawsuit_types.LawsuitType) error {
	// var Otvet lawsuit_types.LawsuitType
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitType_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *lawsuit_types.LawsuitType) error {
	// var Otvet lawsuit_types.LawsuitType
	...
	// запрос
	Response, err := nrpc_client.Client.LawsuitType_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
