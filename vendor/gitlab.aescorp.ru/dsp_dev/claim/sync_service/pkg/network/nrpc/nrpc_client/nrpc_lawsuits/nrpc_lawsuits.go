...
func (crud Crud_NRPC) Read(m *lawsuits.Lawsuit) error {
	...
	// запрос
	Response, err := nrpc_client.Client.Lawsuit_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *lawsuits.Lawsuit) error {
	// var Otvet lawsuits.Lawsuit
	...
	// запрос
	Response, err := nrpc_client.Client.Lawsuit_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *lawsuits.Lawsuit) error {
	// var Otvet lawsuits.Lawsuit
	...
	// запрос
	Response, err := nrpc_client.Client.Lawsuit_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *lawsuits.Lawsuit) error {
	// var Otvet lawsuits.Lawsuit
	...
	// запрос
	Response, err := nrpc_client.Client.Lawsuit_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *lawsuits.Lawsuit) error {
	// var Otvet lawsuits.Lawsuit
	...
	// запрос
	Response, err := nrpc_client.Client.Lawsuit_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *lawsuits.Lawsuit) error {
	// var Otvet lawsuits.Lawsuit
	...
	// запрос
	Response, err := nrpc_client.Client.Lawsuit_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Find_ByExtID(m *lawsuits.Lawsuit) error {
	//подключение
	if nrpc_client.Client == nil {
		nrpc_client.Connect()
	}
	...
	//запрос
	Response, err := nrpc_client.Client.Lawsuit_FindByExtID(Request)
	if err != nil {
		sError := err.Error()
