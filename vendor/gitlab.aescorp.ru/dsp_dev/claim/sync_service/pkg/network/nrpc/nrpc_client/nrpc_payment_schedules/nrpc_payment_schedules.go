...
package nrpc_payment_schedules
...
func (crud Crud_NRPC) Read(m *payment_schedules.PaymentSchedule) error {
	...
	// запрос
	Response, err := nrpc_client.Client.PaymentSchedule_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *payment_schedules.PaymentSchedule) error {
	// var Otvet payment_schedules.PaymentSchedule
	...
	// запрос
	Response, err := nrpc_client.Client.PaymentSchedule_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *payment_schedules.PaymentSchedule) error {
	// var Otvet payment_schedules.PaymentSchedule
	...
	// запрос
	Response, err := nrpc_client.Client.PaymentSchedule_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *payment_schedules.PaymentSchedule) error {
	// var Otvet payment_schedules.PaymentSchedule
	...
	// запрос
	Response, err := nrpc_client.Client.PaymentSchedule_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *payment_schedules.PaymentSchedule) error {
	// var Otvet payment_schedules.PaymentSchedule
	...
	// запрос
	Response, err := nrpc_client.Client.PaymentSchedule_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *payment_schedules.PaymentSchedule) error {
	// var Otvet payment_schedules.PaymentSchedule
	...
	// запрос
	Response, err := nrpc_client.Client.PaymentSchedule_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Find_ByExtID(m *payment_schedules.PaymentSchedule) error {
	//подключение
	if nrpc_client.Client == nil {
		nrpc_client.Connect()
	}
	...
	//запрос
	Response, err := nrpc_client.Client.PaymentSchedule_FindByExtID(Request)
	if err != nil {
		sError := err.Error()
