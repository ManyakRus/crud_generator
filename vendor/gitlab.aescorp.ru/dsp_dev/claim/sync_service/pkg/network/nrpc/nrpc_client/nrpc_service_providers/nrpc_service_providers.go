...
package nrpc_service_providers
...
func (crud Crud_NRPC) Read(m *service_providers.ServiceProvider) error {
	...
	// запрос
	Response, err := nrpc_client.Client.ServiceProvider_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *service_providers.ServiceProvider) error {
	// var Otvet service_providers.ServiceProvider
	...
	// запрос
	Response, err := nrpc_client.Client.ServiceProvider_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *service_providers.ServiceProvider) error {
	// var Otvet service_providers.ServiceProvider
	...
	// запрос
	Response, err := nrpc_client.Client.ServiceProvider_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *service_providers.ServiceProvider) error {
	// var Otvet service_providers.ServiceProvider
	...
	// запрос
	Response, err := nrpc_client.Client.ServiceProvider_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *service_providers.ServiceProvider) error {
	// var Otvet service_providers.ServiceProvider
	...
	// запрос
	Response, err := nrpc_client.Client.ServiceProvider_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *service_providers.ServiceProvider) error {
	// var Otvet service_providers.ServiceProvider
	...
	// запрос
	Response, err := nrpc_client.Client.ServiceProvider_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Find_ByExtID(m *service_providers.ServiceProvider) error {
	//подключение
	if nrpc_client.Client == nil {
		nrpc_client.Connect()
	}
	...
	//запрос
	Response, err := nrpc_client.Client.ServiceProvider_FindByExtID(Request)
	if err != nil {
		sError := err.Error()
