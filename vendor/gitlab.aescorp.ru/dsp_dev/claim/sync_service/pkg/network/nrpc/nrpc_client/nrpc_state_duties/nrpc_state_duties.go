...
func (crud Crud_NRPC) Read(m *state_duties.StateDuty) error {
	...
	// запрос
	Response, err := nrpc_client.Client.StateDuty_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *state_duties.StateDuty) error {
	// var Otvet state_duties.StateDuty
	...
	// запрос
	Response, err := nrpc_client.Client.StateDuty_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *state_duties.StateDuty) error {
	// var Otvet state_duties.StateDuty
	...
	// запрос
	Response, err := nrpc_client.Client.StateDuty_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *state_duties.StateDuty) error {
	// var Otvet state_duties.StateDuty
	...
	// запрос
	Response, err := nrpc_client.Client.StateDuty_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *state_duties.StateDuty) error {
	// var Otvet state_duties.StateDuty
	...
	// запрос
	Response, err := nrpc_client.Client.StateDuty_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *state_duties.StateDuty) error {
	// var Otvet state_duties.StateDuty
	...
	// запрос
	Response, err := nrpc_client.Client.StateDuty_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
