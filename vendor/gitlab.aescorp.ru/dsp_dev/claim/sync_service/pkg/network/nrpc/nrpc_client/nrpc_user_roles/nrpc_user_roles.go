...
func (crud Crud_NRPC) Read(m *user_roles.UserRole) error {
	...
	// запрос
	Response, err := nrpc_client.Client.UserRole_Read(Request)
	if err != nil {
		sError := err.Error()
...
func (crud Crud_NRPC) Create(m *user_roles.UserRole) error {
	// var Otvet user_roles.UserRole
	...
	// запрос
	Response, err := nrpc_client.Client.UserRole_Create(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Update(m *user_roles.UserRole) error {
	// var Otvet user_roles.UserRole
	...
	// запрос
	Response, err := nrpc_client.Client.UserRole_Update(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Save(m *user_roles.UserRole) error {
	// var Otvet user_roles.UserRole
	...
	// запрос
	Response, err := nrpc_client.Client.UserRole_Save(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Delete(m *user_roles.UserRole) error {
	// var Otvet user_roles.UserRole
	...
	// запрос
	Response, err := nrpc_client.Client.UserRole_Delete(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
...
func (crud Crud_NRPC) Restore(m *user_roles.UserRole) error {
	// var Otvet user_roles.UserRole
	...
	// запрос
	Response, err := nrpc_client.Client.UserRole_Restore(Request)
	if err != nil {
		sError := err.Error()
		if len(sError) >= len(constants.TEXT_ERROR_MODEL_VERSION) && sError[0:len(constants.TEXT_ERROR_MODEL_VERSION)] == constants.TEXT_ERROR_MODEL_VERSION {
			log.Panic("table: ", TableName, " error: ", err)
